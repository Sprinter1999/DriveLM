...
def get_image_paths(sample_token):
    ...
    return [
        front_image_path,fl_image_path,fr_image_path,back_image_path,bl_image_path,br_image_path
    ]
...
def convert_csv_to_json(csv_filepath, json_filepath):
    ...
    with open(csv_filepath, newline='', encoding='utf-8') as csvfile:
        ...
        for row in csvreader:
            ...
            image_paths = get_image_paths(sample_token)

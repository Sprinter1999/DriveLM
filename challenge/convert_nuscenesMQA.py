...
def convert_csv_to_json(csv_filepath):
    ...
    with open(csv_filepath, newline='', encoding='utf-8') as csvfile:
        ...
        for row in csvreader:
            #print(row)
            # train has 5 cols (line_num, sample_token...) while val has 4 cols (sample_token,...)
            line, sample_token, question, answer, _ = row  # Assuming four columns; ignore question_type
...
# "./nuScenes-MQA/df_train_mqa.csv"  and "./nuScenes-MQA/df_val_mqa.csv"
file_path = "./nuScenes-MQA/df_train_mqa.csv"
output_file_path = "processed_nuscenesMQA_train_V2.json"

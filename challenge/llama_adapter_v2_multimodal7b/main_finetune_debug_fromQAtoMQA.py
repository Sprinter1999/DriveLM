...
def main(args):
    ...
    # trained ckpt of model(LLaMa adapter) is located at /group/ossdphi_algo_scratch_01/xuefengj/drive_with_language/DriveLM/challenge/llama_adapter_v2_multimodal7b/debug_nuscenesQA
    #TODO: loaded params trained on nuScenes-QA, and we aim to train on MQA from QA
    checkpoint_path_fromQA = "./debug_nuscenesQA/checkpoint-2.pth"  
    model.load_state_dict(torch.load(checkpoint_path_fromQA))  

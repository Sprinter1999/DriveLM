...
OUTPUT_PATH=debug_nuscenesQA
# step1: finetuning
ADAPTER_WEIGHT=pre-trained/1bcbffc43484332672092e0024a8699a6eb5f558161aebf98a7c6b1db67224d1_LORA-BIAS-7B.pth
CONFIG=finetune_data_config_nuscenesqa.yaml #to place the llama-style train data
./exps/finetune_debug.sh $LLAMA_WEIGHT $ADAPTER_WEIGHT $CONFIG $OUTPUT_PATH
